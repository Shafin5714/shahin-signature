    ...
    return (
        <section className="py-24 bg-gray-50 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute -top-24 -right-24 w-96 h-96 bg-[#00AEEF]/5 rounded-full blur-3xl"></div>
                <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-[#002B4A]/5 rounded-full blur-3xl"></div>
            </div>
                                        ...
                                        <div className="mt-auto flex items-center justify-between pt-3 border-t border-gray-100">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="text-xs font-bold text-[#002B4A]">{listing.agent.name}</span>
